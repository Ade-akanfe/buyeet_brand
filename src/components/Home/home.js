...
const RotatingCircleWithIcons = dynamic(() =>
  import("../reusables/icons-circle")
);
const HomePage = () => {
  const arrayResult = [
  ...
  return (
    <div className="w-full h-full relative overflow-hidden flex items-center flex-col ">
      <Header />
      <div className="w-full relative z-20 flex md:mt-9 justify-center max-w-7xl 2xl:max-w-6xl">
        <div className="w-full lg:w-10/12  2xl:w-full py-12 flex flex-row ">
          <div className="w-full  flex justify-center flex-col items-center gap-4">
            <div className="w-10/12 lg:w-11/12 2xl:w-full font-bold leading-8 lg:leading-none text-homeColor font-roboto flex flex-col gap-6 md:gap-5">
              <span className="text-4xl  md:text-4.5xl xl:text-5.5xl  block ">
                It's all
              ...
              <span className="block font-bold text-5.5xl xl:text-6xl">
            ...
            <div className=" m-5 w-10/12 lg:w-11/12 2xl:w-full">
              <JoinWaitList />
            </div>
          </div>
          <div className="hidden w-full h-full lg:flex justify-center items-center ">
            <div className="relative w-80 2xl:w-96 h-80 lg:w-full lg:h-full 2xl:h-full">
              {/* <RotatingCircleWithIcons iconComponents={airdropEl} /> */}
            </div>
          </div>
        </div>
      </div>
